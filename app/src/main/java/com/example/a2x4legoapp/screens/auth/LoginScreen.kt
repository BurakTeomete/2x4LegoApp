...
@Composable
fun LoginScreen(navController: NavController, vm: LegoViewModel){
    ...
    Box(modifier = Modifier. fillMaxSize()) {
        Column(modifier = Modifier
            ...
            Button(
                ...
                modifier = Modifier
                    .width(150.dp)) {
                Text(text = "Login", color = Color.Red, fontWeight = FontWeight.ExtraBold, fontSize = 24.sp)
            }

            Spacer(modifier = Modifier.size(170.dp))

            Row {
                Text(text = "Don't have an account?", color = Color.White,modifier = Modifier.padding(top = 14.dp))
                //Spacer(modifier = Modifier.size(8.dp))
                TextButton(onClick = { navigateTo(navController, DestinationScreen.Signup)}) {
                    Text(text = "Sign up", color = Color.Yellow, fontWeight = FontWeight.ExtraBold, fontSize = 16.sp)
                }
            }
        }
