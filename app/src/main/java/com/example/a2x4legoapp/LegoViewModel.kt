...
import com.example.a2x4legoapp.data.CommentData
import com.example.a2x4legoapp.data.Event
import com.example.a2x4legoapp.data.PostData
import com.example.a2x4legoapp.data.UserData
...
class LegoViewModel @Inject constructor(
    ...
    private fun createOrUpdateProfile(
        ...
        val userData = UserData(
            ...
            coinBalance = userData.value?.coinBalance ?: 0,
            purchasedFigures = userData.value?.purchasedFigures,
            purchasedWallpapers = userData.value?.purchasedWallpapers
        )
    ...
    private fun onCreatePost(imageUri: Uri, description: String, onPostSuccess: () -> Unit) {
        ...
        if (currentUid != null) {
            ...
            val fillerWords = listOf("the", "be", "to", "is", "of", "and", "it", "in")
            ...
            db.collection(POSTS).document(postUuid).set(post)
                ...
                .addOnFailureListener { exc ->
                    handleException(exc, "Unable to crate post")
                    inProgress.value = false
                }
